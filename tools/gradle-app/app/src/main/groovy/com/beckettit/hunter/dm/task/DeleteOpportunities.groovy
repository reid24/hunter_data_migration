...
class DeleteOpportunities extends BaseTask {

    public DeleteOpportunities(String[] args){
        super(args)
    }

    public void run() {
        ObjectDef objDef = Opportunity.getExtractObjectDef()
        ObjectDef migObjDef = Opportunity.getInsertObjectDef()
    ...
    static void main(String[] args) {
        DeleteOpportunities proc = new DeleteOpportunities(args)
        proc.run()
    }
}
