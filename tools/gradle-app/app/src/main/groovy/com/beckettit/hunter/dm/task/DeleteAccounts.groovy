...
class DeleteAccounts extends BaseTask {

    public DeleteAccounts(String[] args){
        super(args)
    }

    public void run() {
        ObjectDef objDef = Account.getExtractObjectDef()
        ObjectDef migObjDef = Account.getInsertParentsObjectDef()
    ...
    static void main(String[] args) {
        DeleteAccounts proc = new DeleteAccounts(args)
        proc.run()
    }
}
